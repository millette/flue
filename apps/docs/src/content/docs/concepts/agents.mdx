...
Flue was the first agent framework to fully embrace this new agent architecture. Flue's built-in TypeScript harness lets you get started today building truely autonomous agents for products, background work, internal tooling and more. We believe this architecture is already defining the future of what agents can do, and we are exited to be helping to lead the charge.
