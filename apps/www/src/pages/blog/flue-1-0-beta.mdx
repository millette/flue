...
Instead of writing a deterministic workflow yourself, Flue agents only need *context*. Define the instructions, tools, skills, and sandbox for the agent, and then watch it go solve whatever tasks you give it, autonomously.
